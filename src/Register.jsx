...
function Register() {
    ...
    return (
        <div className="bg-black mx-auto h-full flex justify-center items-center py-12">
            <section>
                <div class="flex items-center justify-center px-4 py-10 sm:px-6 sm:py-16 lg:px-8 lg:py-8 max-w-3xl">
                    <div class="xl:mx-auto xl:w-full shadow-md p-4 xl:max-w-sm 2xl:max-w-md">
                        ...
                        <h2 class="text-center text-3xl font-bold leading-tight text-white">
                        ...
                        <div className='flex space-x-2'>
                            ...
                            <a class="mt-2 text-center text-sm text-gray-300" href='login'>Sign in to your account</a>
                        </div>
