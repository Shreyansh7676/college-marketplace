  ...
  return (
    <div className="min-h-screen bg-black">
      ...
      <div className="relative py-20 overflow-hidden">
        <div className="bg-gradient-to-r from-violet-800 to-violet-600"></div>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="text-center">
            ...
            <div className="flex flex-col md:flex-row  justify-center gap-4">
              <button className="bg-violet-800 text-white px-8 py-3 rounded-full font-semibold hover:bg-violet-700 transition-colors flex items-center gap-2" onClick={(e)=>navigate('/sell')}>
                Start Selling <ArrowRight size={20} />
              </button>
              <button className="bg-black text-violet-800 px-8 py-3 rounded-full font-semibold border-2 border-violet-800 hover:bg-violet-900 hover:text-white transition-colors hover " onClick={(e)=>navigate('/products')}>
                Browse Items
              </button>
            </div>
          </div>
      ...
      {/* Popular Categories */}
      <div className="py-24 border-t border-violet-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="bg-black border-t border-violet-800 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <button className="bg-black text-white px-8 py-3 rounded-full font-semibold hover:bg-violet-900 transition border border-violet-600 hover:scale-110 ease-in duration-100" onClick={(e)=>navigate('/register')}>
            Create Your Account
          </button>
        </div>
      </div>
